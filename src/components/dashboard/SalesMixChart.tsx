  ...
  return (
    <div>
      <div className="flex gap-2">
        <div
          className="flex shrink-0 flex-col justify-between text-right text-[10px] font-medium text-ink-muted"
          style={{ height: CHART_HEIGHT }}
        >
          <span>{formatMoneyCompact(maxBar)}</span>
          <span>{formatMoneyCompact(maxBar / 2)}</span>
          <span>0</span>
        </div>
